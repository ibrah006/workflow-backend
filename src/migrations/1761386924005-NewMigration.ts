...
export class NewMigration1761386924005 implements MigrationInterface {
    name = 'NewMigration1761386924005'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        // await queryRunner.query(`CREATE TYPE IF NOT EXISTS "material_log_type_enum" AS ENUM('IN', 'OUT', 'ESTIMATE')`);
        // await queryRunner.query(`CREATE TYPE IF NOT EXISTS "material_log_type_enum" AS ENUM('IN', 'OUT', 'ESTIMATE')`);
        // await queryRunner.query(`CREATE TYPE IF NOT EXISTS "material_log_type_enum" AS ENUM('IN', 'OUT', 'ESTIMATE')`);
        // await queryRunner.query(`CREATE TYPE IF NOT EXISTS "material_log_type_enum" AS ENUM('IN', 'OUT', 'ESTIMATE')`);
        // await queryRunner.query(`CREATE TYPE IF NOT EXISTS "material_log_type_enum" AS ENUM('IN', 'OUT', 'ESTIMATE')`);
        ...
        // await queryRunner.query(`CREATE TYPE IF NOT EXISTS "material_log_type_enum" AS ENUM('IN', 'OUT', 'ESTIMATE')`);
        // await queryRunner.query(`CREATE TYPE IF NOT EXISTS "material_log_type_enum" AS ENUM('IN', 'OUT', 'ESTIMATE')`);
        await queryRunner.query(`CREATE TABLE IF NOT EXISTS "material_log" ("id" SERIAL NOT NULL, "description" character varying NOT NULL, "quantity" integer NOT NULL, "width" numeric NOT NULL, "height" numeric NOT NULL, "dateCreated" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "type" "material_log_type_enum" NOT NULL, "loggedById" uuid, "projectId" character varying, CONSTRAINT "PK_b7b40a603aa5403ce04c2643aa2" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE IF NOT EXISTS "material_log" ("id" SERIAL NOT NULL, "description" character varying NOT NULL, "quantity" integer NOT NULL, "width" numeric NOT NULL, "height" numeric NOT NULL, "dateCreated" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "type" "material_log_type_enum" NOT NULL, "loggedById" uuid, "projectId" character varying, CONSTRAINT "PK_b7b40a603aa5403ce04c2643aa2" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE IF NOT EXISTS "material_log" ("id" SERIAL NOT NULL, "description" character varying NOT NULL, "quantity" integer NOT NULL, "width" numeric NOT NULL, "height" numeric NOT NULL, "dateCreated" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "type" "material_log_type_enum" NOT NULL, "loggedById" uuid, "projectId" character varying, CONSTRAINT "PK_b7b40a603aa5403ce04c2643aa2" PRIMARY KEY ("id"))`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX "IDX_43a779234ed899161f17f93613"`);
        await queryRunner.query(`DROP INDEX "IDX_d9fd4807ea74dadce7f705af6f"`);
        await queryRunner.query(`DROP TABLE "project_assigned_managers_user"`);
        await queryRunner.query(`DROP INDEX "IDX_d3ab8572b56640902c3f40fcaa"`);
        await queryRunner.query(`DROP INDEX "IDX_6779281224d4075bfd0c18fdc2"`);
        await queryRunner.query(`DROP TABLE "task_assignees_user"`);
        await queryRunner.query(`DROP INDEX "IDX_2eac15d72bc9f55fe39cd87d9d"`);
        await queryRunner.query(`DROP INDEX "IDX_b9139f00cebfadced76bca3084"`);
        await queryRunner.query(`DROP INDEX "IDX_e577dcf9bb6d084373ed399850"`);
        ...
        await queryRunner.query(`DROP TYPE "material_log_type_enum"`);
