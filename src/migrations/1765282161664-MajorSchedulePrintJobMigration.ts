...
export class MajorSchedulePrintJobMigration1765282161664 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "progress_log" ("id" uuid NOT NULL, "status" character varying NOT NULL, "isCompleted" boolean NOT NULL DEFAULT false, "description" character varying, "issue" character varying, "dueDate" date, "startDate" date NOT NULL DEFAULT ('now'::text)::date, "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "completedAt" TIMESTAMP WITH TIME ZONE, "projectId" character varying, "taskId" integer NOT NULL, CONSTRAINT "PK_59ba81d77fc262fe624293fbaf2" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TYPE "public"."printers_status_enum" AS ENUM('active', 'paused', 'maintenance', 'offline')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."stock_transactions_type_enum" AS ENUM('stock_in', 'stock_out', 'adjustment')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."materials_measuretype_enum" AS ENUM('running_meter', 'item_quantity', 'liters', 'kilograms', 'square_meter')`);
        ...
        await queryRunner.query(`CREATE TABLE "work_activity_log" ("id" SERIAL NOT NULL, "start" TIMESTAMP NOT NULL, "end" TIMESTAMP, "department" character varying NOT NULL, "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "userId" uuid, "taskId" integer, CONSTRAINT "PK_e1f13a1dd67ba9634126ee12684" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TYPE "public"."invitations_status_enum" AS ENUM('pending', 'accepted', 'cancelled', 'expired')`);
