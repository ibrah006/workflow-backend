...
export class NewMigration1760782128005 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE IF NOT "wastage_log" ("id" SERIAL NOT NULL, "invoiceItemId" character varying NOT NULL, "wastage" numeric NOT NULL, "taskId" integer, CONSTRAINT "PK_89e6f56f3780ecf7acecd5d4ffd" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE IF NOT "message" ("id" SERIAL NOT NULL, "message" character varying NOT NULL, "date" date NOT NULL, "userId" uuid, "taskId" integer, CONSTRAINT "PK_ba01f0a3e0123651915008bc578" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE IF NOT "progress_log" ("id" uuid NOT NULL, "status" character varying NOT NULL, "isCompleted" boolean NOT NULL DEFAULT false, "description" character varying, "issue" character varying, "dueDate" date, "startDate" date NOT NULL DEFAULT ('now'::text)::date, "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "completedAt" TIMESTAMP WITH TIME ZONE, "projectId" character varying, CONSTRAINT "PK_59ba81d77fc262fe624293fbaf2" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE IF NOT "task" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "description" character varying, "dueDate" TIMESTAMP, "assigneesLastAdded" TIMESTAMP WITH TIME ZONE, "status" character varying NOT NULL DEFAULT 'pending', "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "workActivityLogsLastModifiedAt" TIMESTAMP WITH TIME ZONE, "dateCompleted" date, "projectId" character varying, "progressLogId" uuid NOT NULL, CONSTRAINT "PK_fb213f79ee45060ba925ecd576e" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE IF NOT "company" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "description" character varying, "isActive" boolean NOT NULL DEFAULT true, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "organizationId" uuid NOT NULL, "createdById" uuid NOT NULL, CONSTRAINT "PK_056f7854a7afdba7cbd6d45fc20" PRIMARY KEY ("id"))`);
        await this.createEnumIfNotExists(queryRunner, 'material_log_type_enum', ['IN', 'OUT', 'ESTIMATE']);
        await queryRunner.query(`CREATE TABLE IF NOT "material_log" ("id" SERIAL NOT NULL, "description" character varying NOT NULL, "quantity" integer NOT NULL, "width" numeric NOT NULL, "height" numeric NOT NULL, "dateCreated" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "type" "public"."material_log_type_enum" NOT NULL, "loggedById" uuid, "projectId" character varying, CONSTRAINT "PK_b7b40a603aa5403ce04c2643aa2" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE IF NOT "project" ("id" character varying NOT NULL, "organizationId" uuid NOT NULL, "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "name" character varying NOT NULL, "description" character varying, "status" character varying NOT NULL, "dateStarted" date DEFAULT now(), "dueDate" date, "estimatedProductionStart" date, "estimatedSiteFixing" date, "priority" integer NOT NULL DEFAULT '0', "progressLogLastModifiedAt" TIMESTAMP WITH TIME ZONE, "tasksLastModifiedAt" TIMESTAMP WITH TIME ZONE, "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "clientId" uuid, CONSTRAINT "PK_4d68b1358bb5b766d3e78f32f57" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE IF NOT "organization" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "description" character varying, "createdById" uuid NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_c21e615583a3ebbb0977452afb0" UNIQUE ("name"), CONSTRAINT "PK_472c1f99a32def1b0abb219cd67" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE IF NOT "team" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "description" character varying NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "organizationId" uuid NOT NULL, "createdById" uuid, CONSTRAINT "PK_f57d8293406df4af348402e4b74" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE IF NOT "attendance_log" ("id" SERIAL NOT NULL, "checkIn" TIMESTAMP NOT NULL, "checkOut" TIMESTAMP, "userId" uuid, CONSTRAINT "PK_c5f15a2267f6b4a7174001ea912" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE IF NOT "layoff_log" ("id" SERIAL NOT NULL, "start" TIMESTAMP NOT NULL, "end" TIMESTAMP, "userId" uuid, CONSTRAINT "PK_ca16eca8fcf76bf912aab867cad" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE IF NOT "user" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "role" character varying NOT NULL DEFAULT 'viewer', "email" character varying NOT NULL, "password" character varying NOT NULL, "phone" integer, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "skills" text array NOT NULL DEFAULT '{}', "efficiencyScore" numeric NOT NULL DEFAULT '0', "duration" integer NOT NULL DEFAULT '0', "departmentId" integer, "organizationId" uuid, CONSTRAINT "UQ_e12875dfb3b1d92d7d7c5377e22" UNIQUE ("email"), CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE IF NOT "work_activity_log" ("id" SERIAL NOT NULL, "start" TIMESTAMP NOT NULL, "end" TIMESTAMP, "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "userId" uuid, "taskId" integer, CONSTRAINT "PK_e1f13a1dd67ba9634126ee12684" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE IF NOT "task_assignees_user" ("taskId" integer NOT NULL, "userId" uuid NOT NULL, CONSTRAINT "PK_910c37c13f72414640db814dc60" PRIMARY KEY ("taskId", "userId"))`);
        await queryRunner.query(`CREATE INDEX IF NOT "IDX_6779281224d4075bfd0c18fdc2" ON "task_assignees_user" ("taskId") `);
        await queryRunner.query(`CREATE INDEX IF NOT "IDX_d3ab8572b56640902c3f40fcaa" ON "task_assignees_user" ("userId") `);
        await queryRunner.query(`CREATE TABLE IF NOT "project_assigned_managers_user" ("projectId" character varying NOT NULL, "userId" uuid NOT NULL, CONSTRAINT "PK_9b9939fb151e0e4616bf478db0b" PRIMARY KEY ("projectId", "userId"))`);
        await queryRunner.query(`CREATE INDEX IF NOT "IDX_d9fd4807ea74dadce7f705af6f" ON "project_assigned_managers_user" ("projectId") `);
        await queryRunner.query(`CREATE INDEX IF NOT "IDX_43a779234ed899161f17f93613" ON "project_assigned_managers_user" ("userId") `);
