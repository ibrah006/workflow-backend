...
export class NewestMigration1761215583290 implements MigrationInterface {
    name = 'NewestMigration1761215583290'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "material_log_type_enum" AS ENUM('IN', 'OUT', 'ESTIMATE')`);
        ...
        await queryRunner.query(`CREATE TYPE "invitations_status_enum" AS ENUM('pending', 'accepted', 'cancelled', 'expired')`);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_2eac15d72bc9f55fe39cd87d9d" ON "invitations" ("email", "organizationId", "status") `);
