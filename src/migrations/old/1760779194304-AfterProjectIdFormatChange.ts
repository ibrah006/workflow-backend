...
export class AfterProjectIdFormatChange1760779194304 implements MigrationInterface {
    name = 'AfterProjectIdFormatChange1760779194304'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "project" ("id" character varying NOT NULL, "name" character varying NOT NULL, "description" character varying, "status" character varying NOT NULL, "dateStarted" date DEFAULT now(), "dueDate" date, "estimatedProductionStart" date, "estimatedSiteFixing" date, "priority" integer NOT NULL DEFAULT '0', "progressLogLastModifiedAt" TIMESTAMP WITH TIME ZONE, "tasksLastModifiedAt" TIMESTAMP WITH TIME ZONE, "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "clientId" uuid, CONSTRAINT "PK_4d68b1358bb5b766d3e78f32f57" PRIMARY KEY ("id"))`);
