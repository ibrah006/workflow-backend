...
export class InitialMigration1759477737280 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "company" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "description" character varying, "isActive" boolean NOT NULL DEFAULT true, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "createdById" uuid NOT NULL, CONSTRAINT "PK_056f7854a7afdba7cbd6d45fc20" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "progress_log" ("id" uuid NOT NULL, "status" character varying NOT NULL, "isCompleted" boolean NOT NULL DEFAULT false, "description" character varying, "issue" character varying, "dueDate" date, "startDate" date NOT NULL DEFAULT ('now'::text)::date, "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "completedAt" TIMESTAMP WITH TIME ZONE, "projectId" uuid, CONSTRAINT "PK_59ba81d77fc262fe624293fbaf2" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "project" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "description" character varying, "status" character varying NOT NULL, "dateStarted" date DEFAULT now(), "dueDate" date, "estimatedProductionStart" date, "estimatedSiteFixing" date, "priority" integer NOT NULL DEFAULT '0', "progressLogLastModifiedAt" TIMESTAMP WITH TIME ZONE, "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "clientId" uuid, CONSTRAINT "PK_4d68b1358bb5b766d3e78f32f57" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "work_activity_log" ("id" SERIAL NOT NULL, "start" TIMESTAMP NOT NULL, "end" TIMESTAMP, "userId" uuid, "taskId" integer, CONSTRAINT "PK_e1f13a1dd67ba9634126ee12684" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TYPE "public"."material_log_type_enum" AS ENUM('IN', 'OUT', 'ESTIMATE')`);
        await queryRunner.query(`CREATE TABLE "material_log" ("id" SERIAL NOT NULL, "itemId" character varying NOT NULL, "measure" numeric NOT NULL, "datetime" TIMESTAMP NOT NULL, "type" "public"."material_log_type_enum" NOT NULL, "loggedById" uuid, "materialsUsedTaskId" integer, "materialsEstimatedTaskId" integer, CONSTRAINT "PK_b7b40a603aa5403ce04c2643aa2" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "task" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "description" character varying, "dueDate" TIMESTAMP, "status" character varying NOT NULL DEFAULT 'pending', "dateCompleted" date, "projectId" uuid, "progressLogId" uuid NOT NULL, CONSTRAINT "PK_fb213f79ee45060ba925ecd576e" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "user" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "role" character varying NOT NULL DEFAULT 'viewer', "email" character varying NOT NULL, "password" character varying NOT NULL, "phone" integer, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "skills" text array NOT NULL DEFAULT '{}', "efficiencyScore" numeric NOT NULL DEFAULT '0', "duration" integer NOT NULL DEFAULT '0', "departmentId" integer, CONSTRAINT "UQ_e12875dfb3b1d92d7d7c5377e22" UNIQUE ("email"), CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "team" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "description" character varying NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "createdById" uuid, CONSTRAINT "PK_f57d8293406df4af348402e4b74" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "project_assigned_managers_user" ("projectId" uuid NOT NULL, "userId" uuid NOT NULL, CONSTRAINT "PK_9b9939fb151e0e4616bf478db0b" PRIMARY KEY ("projectId", "userId"))`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "material_log" DROP CONSTRAINT "FK_08f0f39bcc1000fb379608e10e1"`);
        await queryRunner.query(`ALTER TABLE "material_log" DROP CONSTRAINT "FK_a7b37e0d416fa7f66ba59b44ed0"`);
