...
export class PrinterActivityTracking1766308686208 implements MigrationInterface {
    name = 'PrinterActivityTracking1766308686208'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "printers" ADD "taskAssignedAt" TIMESTAMP WITH TIME ZONE`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "printers" DROP COLUMN "taskAssignedAt"`);
